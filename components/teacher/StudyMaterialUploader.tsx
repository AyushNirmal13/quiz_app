...
export function StudyMaterialUploader({ onQuestionsGenerated }: StudyMaterialUploaderProps) {
    ...
    return (
      <div style={{ display: "grid", gap: "1rem" }}>
        ...
        >
          ...
          <p style={{ margin: "0.25rem 0 1rem", color: "var(--color-muted)", fontSize: "0.9rem" }}>Max 10MB — GPT-4o-mini will generate quiz questions from the content</p>
  ...
  if (state === "generating") {
    return (
      <div style={{ ...boxStyle, cursor: "default" }}>
        <p style={{ fontSize: "2rem", margin: "0 0 0.5rem" }}>✨</p>
        <p style={{ margin: 0, fontWeight: "600" }}>GPT-4o-mini is analyzing your document and generating questions...</p>
